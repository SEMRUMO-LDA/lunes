...
import { X, ArrowLeft, Leaf, Heart, RefreshCw, Bird } from "lucide-react";
...
export default function FilosofiaPage() {
  ...
  const onClose = () => router.push("/feel");
      ...
      <div className="max-w-4xl mx-auto px-8 py-24 md:py-32">
        ...
        <header className="mb-24">
          ...
          <motion.h1
            ...
            className="text-6xl md:text-8xl italic mb-8 tracking-tighter"
          >
            A Nossa Filosofia
          </motion.h1>
          <motion.p
        ...
        <div className="space-y-24 text-blackout/80 leading-relaxed font-light font-sans">
          ...
          >
            <a
              href="/feel"
              className="inline-block px-12 py-5 rounded-full bg-feel-athletics text-feel-sage text-[10px] uppercase tracking-[0.5em] font-sans font-bold hover:scale-105 transition-all duration-300 shadow-xl shadow-feel-athletics/20"
            >
              Descobrir LUNES FEEL
            </a>
          </motion.section>
