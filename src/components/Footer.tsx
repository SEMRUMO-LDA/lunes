    ...
    <footer className="bg-blackout text-coconut relative overflow-hidden font-sans">
      ...
      <div className="md:hidden px-6 pt-16 pb-10 relative z-10">
        ...
        <div className="flex justify-center gap-10 mb-10">
          <InstagramIcon className="w-6 h-6 opacity-70 hover:opacity-100 cursor-pointer transition-opacity" />
          <FacebookIcon className="w-6 h-6 opacity-70 hover:opacity-100 cursor-pointer transition-opacity" />
          {onContactClick ? (
