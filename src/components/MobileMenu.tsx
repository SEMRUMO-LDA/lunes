            ...
            >
              ...
              <div className="flex justify-center gap-8">
                <a href="https://chat.whatsapp.com/LhAgTtMugty7lPTxCo8wrE?mode=gi_t" target="_blank" rel="noopener noreferrer">
                  <WhatsAppIcon className="w-5 h-5 text-coconut/30 hover:text-coconut/70 cursor-pointer transition-colors" />
                </a>
                {onContactClick ? (
                  <div onClick={() => { onContactClick(); setIsOpen(false); }} className="cursor-pointer">
                    <Mail className="w-5 h-5 text-coconut/30 hover:text-coconut/70 transition-colors" />
                  </div>
                ) : (
